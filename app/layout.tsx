...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bocilsmp.pro"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'hRaQB3iEBf7oSZuO_v2m9eE8SIWjBlFQioTFGYDkSAo',
        yandex: '',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "logo": "https://bocilsmp.pro/favicon.ico",
        "url": "https://bocilsmp.pro",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bocilsmp.pro"
        ...
        "url": "https://bocilsmp.pro",
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "image": "https://bocilsmp.pro/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bocilsmp.pro"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bocilsmp.pro/?q={search_term}", 
